...
Some common ones:
* `var num = Number('747');	//	Converts argument to number`
* `var floate = parseFloat('902.59');	//	Converts argument to number`
* `var int = parseInt(894.22);	//	Converts argument to number, truncating decimal`
* `var stringly = String(989);	//	Converts argument to string`
* ```var y = num.toString();	//	Converts variable (called) to string````
